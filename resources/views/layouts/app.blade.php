 ...
 <!-- End Chatbot -->
       ...
       <header class="navbar p-0 pe-0 ps-2 ps-xl-5 ">
        ...
        >
          ...
          >
            ...
            >
              أضف طلبك <i class="fa-solid fa-plus ms-1"></i>
            </a>
            <a
      ...
      <div class="side-bar drop">
        ...
        <div class="navbar-nav p-0" dir="rtl">
          ...
          <li class="nav-item p-0 ">
              <a class="nav-item nav-link fw-bolder pt-4 pb-4 p-3" href="{{ route('login') }}">{{ __('تسجيل الدخول') }}   </a>
            </li>
          @endif

          @if (Route::has('register'))
          <li class="nav-item p-0 ">
              <a class="nav-item nav-link fw-bolder pt-4 pb-4 p-3" href="{{ route('register') }}">{{ __('تسحيل فى الموقع') }} </a>
            </li>
          @endif
      @else


                  <a class="nav-item nav-link fw-bolder pt-4 pb-4 p-3" href="{{ route('logout') }}"
      ...
      @endguest
          ...
          <a
            ...
            href="./pages/add-work.html"
          >
            <i class="fa-solid fa-sheet-plastic ms-1"></i> طلباتك
          </a>
          <a
            class="nav-item nav-link w-100 fw-bolder"
      ...
      <!-- End Sidebar -->
        ...
        <!-- Start Up Footer -->
        <div class="up-footer p-3">
            <div class="row flex-row-reverse justify-content-center">
              <div
                class="col-md-4 col-sm-6 col-12 d-flex align-items-center text-center flex-column mt-3"
              >
                <h2>المساعد</h2>
                <a
                  class="text-decoration-none col-xl-5 col-9 text-black text-center m-2 p-2"
                  href="#"
                  >عن المساعد</a
                >
                <a
              ...
              <div
                class="col-md-4 col-sm-6 col-12 d-flex text-center flex-column mt-3"
              >
                <h2>وسائل التواصل</h2>
                <div class="d-flex justify-content-center mt-2 mb-5">
                  <a
                    class="text-decoration-none text-black text-center m-2 p-0"
                    href="#"
                  >
                    <svg
                      version="1.1"
